      ...
      <div className="max-w-7xl mx-auto px-1 py-10 grid grid-cols-1 sm:grid-cols-3 gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li><Link href="/" className="hover:text-white relative font-semibold  
             after:content-[''] after:absolute after:left-0 after:-bottom-1 
             after:w-0 after:h-[2px] after:bg-white 
             after:transition-all after:duration-300 
             hover:after:w-full">Rotas</Link></li>
            <li><Link href="/status" className="hover:text-white relative font-semibold  
             after:content-[''] after:absolute after:left-0 after:-bottom-1 
             after:w-0 after:h-[2px] after:bg-white 
             after:transition-all after:duration-300 
             hover:after:w-full">Status</Link></li>
            <li><Link href="/suporte" className="hover:text-white relative font-semibold  
             after:content-[''] after:absolute after:left-0 after:-bottom-1 
             after:w-0 after:h-[2px] after:bg-white 
             after:transition-all after:duration-300 
             hover:after:w-full">Suporte</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li><a href="https://www.viamobilidade.com.br/nos/empresas" className="hover:text-white relative font-semibold  
             after:content-[''] after:absolute after:left-0 after:-bottom-1 
             after:w-0 after:h-[2px] after:bg-white 
             after:transition-all after:duration-300 
             hover:after:w-full">Sobre Nós</a></li>
            <li><a href="https://viamobilidade.com.br/politica-de-privacidade" className="hover:text-white relative font-semibold  
             after:content-[''] after:absolute after:left-0 after:-bottom-1 
             after:w-0 after:h-[2px] after:bg-white 
             after:transition-all after:duration-300 
             hover:after:w-full">Política de Privacidade</a></li>
            <li><a href="https://www.viamobilidade.com.br/termos-de-uso" className="hover:text-white relative font-semibold  
             after:content-[''] after:absolute after:left-0 after:-bottom-1 
             after:w-0 after:h-[2px] after:bg-white 
             after:transition-all after:duration-300 
             hover:after:w-full">Termos de uso</a></li>
          </ul>
        </div>
      </div>
